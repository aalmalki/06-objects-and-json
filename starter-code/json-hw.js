...
//iterate through items and display title and date_taken on the console

for (var i = 0; i < flickerObj.items.length; i++) {

//display details

console.log(flickerObj.items[i].title + "." + flickerObj.items[0].date_taken);
